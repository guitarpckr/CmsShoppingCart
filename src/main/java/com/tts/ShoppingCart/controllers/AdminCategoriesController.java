...
//		List<Category> categories = categoryRepo.findAllByOrderSortingAsc();
	...
	@PostMapping("/add")
	public String add(@Validated Category category, BindingResult bindingResult, RedirectAttributes redirectAttributes, 
			Model model) {
	...
	@PostMapping("/edit")
	public String edit(@Validated Category category, BindingResult bindingResult, RedirectAttributes redirectAttributes, Model model) {
